...
5. 매개변수를 하나도 선언하지 않을 수도 있습니다.
이때는 메서드의 선언부() 내부를 비워둡니다.
그리고 호출할 때도 ()를 비워서 호출합니다.

반드시 정해져있는 타입과 값을 호출부에 체워야 한다.
...
public class MethodExample2 {
	...
	static String selectRandomFood() { //선언 할때 괄호가 없으면 안됀다 없다면 변수로 선언된다.
		double rn = Math.random();		//괄호가 있어야 함수로 인식한다.
		if(rn > 0.66) {
			return "치킨";
	...
	public static void main(String[] args) {
		...
		//배열로 포장해서 보내도 됩니다.
		sum = calcNumberTotal2(1,2,3,4,5,6,7);//변하는것이 가능한 가변인수
		System.out.println("누적합: " + sum);
