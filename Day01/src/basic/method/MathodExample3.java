...
public class MathodExample3 {
	...
	static int[] operateTotal(int n1, int n2){   
		return new int[] {add(n1, n2), n1-n2, n1*n2, n1/n2}; //값을 호출과 동시에 리턴하고 나서 강제로 끝낸다는 것이다.
	...
	public static void main(String[] args) {
		...
		int r3 = add(add(4,6), add(7,8)); //int r3 = 10 + 15 = 25
		...
		2. 이 메서드는 점수 배열을 하나 전달받아서 해당 배열 내부에 있는
		...
		/*
		- 반환값이 없는 void 타입의 메서드는 ㅏㄱㅄ이 돌아오지 않기 때문에
