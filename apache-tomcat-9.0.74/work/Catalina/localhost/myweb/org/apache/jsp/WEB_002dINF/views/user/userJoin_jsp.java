 ...
 * Generated at: 2023-05-23 02:28:37 UTC
...
public final class userJoin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/user/../include/header.jsp", Long.valueOf(1684808721705L));
    _jspx_dependants.put("/WEB-INF/views/user/../include/footer.jsp", Long.valueOf(1684808721704L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/user/join\" method=\"post\" name=\"joinForm\">\r\n");
      ...
      out.write("								placeholder=\"아이디를 (영문포함 4~12자 이상)\">\r\n");
      ...
      out.write("						<input type=\"password\" name=\"userPw\" class=\"form-control\" id=\"userPw\"\r\n");
      ...
      out.write("						<input type=\"text\" name=\"userName\" class=\"form-control\" id=\"userName\" placeholder=\"이름을 입력하세요.\">\r\n");
      out.write("					</div>\r\n");
      out.write("					<!--input2탭의 input-addon을 가져온다 -->\r\n");
      out.write("					<div class=\"form-group\">\r\n");
      out.write("						<label for=\"hp\">휴대폰번호</label>\r\n");
      out.write("						<div class=\"input-group\">\r\n");
      out.write("							<select name=\"userPhone1\" class=\"form-control phone1\" id=\"userPhone1\">\r\n");
      out.write("								<option>010</option>\r\n");
      out.write("								<option>011</option>\r\n");
      out.write("								<option>017</option>\r\n");
      out.write("								<option>018</option>\r\n");
      out.write("							</select>\r\n");
      out.write("							<input type=\"text\" name=\"userPhone2\" class=\"form-control phone2\" id=\"userPhone2\"\r\n");
      ...
      out.write("						<div class=\"input-group\">\r\n");
      out.write("							<input type=\"text\" name=\"userEmail1\" class=\"form-control\" id=\"userEmail1\" placeholder=\"이메일\">\r\n");
      out.write("							<select name=\"userEmail2\" class=\"form-control\" id=\"userEmail2\">\r\n");
      ...
      out.write("						<div class=\"input-group\">\r\n");
      out.write("							<input type=\"text\" name=\"addrZipNum\" class=\"form-control\" id=\"addrZipNum\" placeholder=\"우편번호\"\r\n");
      out.write("								readonly>\r\n");
      out.write("							<div class=\"input-group-addon\">\r\n");
      out.write("								<button type=\"button\" class=\"btn btn-primary\" onclick=\"searchAddress()\">주소찾기</button>\r\n");
      out.write("							</div>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      out.write("					<div class=\"form-group\">\r\n");
      out.write("						<input type=\"text\" name=\"addrBasic\" class=\"form-control\" id=\"addrBasic\" placeholder=\"기본주소\">\r\n");
      out.write("					</div>\r\n");
      out.write("					<div class=\"form-group\">\r\n");
      out.write("						<input type=\"text\" name=\"addrDetail\" class=\"form-control\" id=\"addrDetail\" placeholder=\"상세주소\">\r\n");
      out.write("					</div>\r\n");
      out.write("\r\n");
      out.write("					<!--button탭에 들어가서 버튼종류를 확인한다-->\r\n");
      out.write("					<div class=\"form-group\">\r\n");
      out.write("						<button type=\"button\" id=\"joinBtn\" class=\"btn btn-lg btn-success btn-block\">회원가입</button>\r\n");
      out.write("					</div>\r\n");
      out.write("\r\n");
      out.write("					<div class=\"form-group\">\r\n");
      ...
      out.write("	let idFlag, pwFlag; //정규표현식 유효성 검사 여부 판단.\r\n");
      out.write("\r\n");
      out.write("	//아이디 중복 체크\r\n");
      ...
      out.write("		xhr.setRequestHeader('content-type', 'text/plain');\r\n");
      ...
      out.write("		.then(res => {\r\n");
      out.write("			//fetch 함수를 통해 비동기 통신이 실행되고, \r\n");
      out.write("			//요청이 완료 된 후 then()의 매개값으로 응답에 관련된\r\n");
      out.write("			//함수를 콜백 방식으로 전달합니다.\r\n");
      out.write("			//함수의 매개변수를 선언하면 해당 매개변수로 응답에 관련된\r\n");
      out.write("			//전반적인 정보를 가진 응답 정보가 전달됩니다.\r\n");
      ...
      out.write("			.then(data => { //텍스트만 뺀 Promise 객체로부터 data 전달받음.\r\n");
      ...
      out.write("\r\n");
      out.write("			//초기값을 사용자가 선택한 값으로 무조건 설정하는 방법(select에서 readonly 대용)\r\n");
      out.write("			//항상 2개 같이 쓰셔야 해요.\r\n");
      ...
      out.write("	} //인증번호 검증 끝.\r\n");
      out.write("\r\n");
      out.write("	//다음 주소 api 사용해 보기 (script src 추가 해야합니다.)\r\n");
      ...
      out.write("\r\n");
      out.write("	//폼 데이터 검증 (회원 가입 버튼 눌렀을 시)\r\n");
      out.write("	document.getElementById('joinBtn').onclick = function () {\r\n");
      out.write("\r\n");
      out.write("		if (idFlag && pwFlag) {\r\n");
      out.write("			if (!document.getElementById('userId').getAttribute('readonly')) {\r\n");
      out.write("				alert('아이디 중복체크는 필수입니다.');\r\n");
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("			if (document.getElementById('userPw').value \r\n");
      out.write("					!== document.getElementById('pwConfirm').value) {\r\n");
      ...
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("			if(!document.getElementById('mail-check-btn').disabled) {\r\n");
      out.write("				alert('이메일 인증을 완료해 주세요.');\r\n");
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("\r\n");
      out.write("			if(confirm('회원가입을 진행합니다.')) {\r\n");
      ...
      out.write("			메타 문자 입니다.\r\n");
      out.write("		*/\r\n");
      out.write("		/*test메서드를 통해 비교하며, 매칭되면 true, 아니면 false 반환 */\r\n");
      ...
      out.write("			document.getElementById(\"msgPw\").innerHTML = \"비밀번호를 제대로 입력하세요~\";\r\n");
